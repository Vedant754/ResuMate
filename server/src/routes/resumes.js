...
// GET /api/resumes/:id/analyses  (history for the resume)
router.get(
  "/:id/analyses",
  validate(idParam, "params"),
  asyncHandler(async (req, res) => {
...
// ─── Rewrite (apply chosen rewrites → new version) ─────────────────────
...
// Replaces matching bullets in a cloned copy of parsedSections so we can
// hand the user a structured V2 even if Gemini parsing fails downstream.
